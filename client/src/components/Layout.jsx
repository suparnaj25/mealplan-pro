...
import { CalendarDays, ShoppingCart, Package, Settings, Moon, Sun, LogOut, ChefHat, Menu, X } from 'lucide-react';
            ...
            >
              <div className="flex flex-col h-full">
                ...
                <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
                  ...
                  >
                    <span className="text-2xl">🍽️</span>
                    <span className="text-lg font-bold tracking-tight bg-gradient-to-r from-brand-500 to-emerald-400 bg-clip-text text-transparent">
                      MealPlan Pro
                    </span>
                  </button>
                  <button
